...
export const testimonials = {
  card1: {
    ...
    content: (
      <>
        <p className="text-sm leading-relaxed mb-4 text-[#777777]">
        ...
        <p className="text-sm leading-relaxed mb-4 text-[#777777]">
          ...
          <strong className="font-semibold text-[#333]"> Thanks to GDG Noida, I found the direction and inspiration to follow my passion. </strong>
    ...
    author: {
      name: 'Shekhor Patel',
      title: 'GSOC\'24, The Palisades Foundation',
      imgSrc: '/images/shekhor-patel.png',
    },
  },
  ...
  card2: {
    ...
    content: (
      <p className="text-sm leading-relaxed mb-4 text-[#777777]">
        <strong className="font-semibold text-[#333]">GDG Noida introduced me to open-source tech communities.</strong> 
  ...
  card3: {
    ...
    content: (
      <p className="text-sm leading-relaxed mb-4 text-[#777777]">
        ...
        <strong className="font-semibold text-[#333]">Thanks to GDG Noida, I’ve improved my analytical thinking and task management skills and landed great opportunities.</strong>
      </p>
    ),
    author: {
      name: 'Abhinav Jha',
  ...
  card4: {
    ...
    content: (
      <p className="text-sm leading-relaxed mb-4 text-[#777777]">
        ...
        <strong className="font-semibold text-[#333]">I am grateful to DevFest Noida for providing me with this opportunity to connect with great designers,</strong> 
  ...
  card5: {
    ...
    content: (
      <p className="text-sm leading-relaxed mb-4 text-[#777777]">
        ...
        <strong className="font-semibold text-[#333]">I’ll never forget speaking at the Women’s Day event, #DareToBe.</strong> 
        I was terrified, but they believed in me and gave me the courage to step into the spotlight. 
        <strong className="font-semibold text-[#333]">The connections I made built a reliable support system.</strong> 
